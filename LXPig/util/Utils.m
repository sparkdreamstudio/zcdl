...
+(CGSize)getSizeOfString:(NSString*)string WithSize:(CGSize)size AndFont:(UIFont*)font
{
    ...
    if (IOS_SYSTEM_VERSION < 7.0f) {
        returnSize = [string sizeWithFont:font constrainedToSize:size lineBreakMode:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading];
    }
    else
    {
        returnSize = [string boundingRectWithSize:size options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:font} context:nil ].size;
    }
    return returnSize;
}
